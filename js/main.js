...
const getAllUsers = () => {
    ...
    $.ajax({
        ...
        headers: {
            "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxMWM3NmFjMGFlN2IzMjE0NjNmNGI4NyIsImlhdCI6MTYyOTI2Njc1OSwiZXhwIjoxNjI5MzUzMTU5fQ.WESZKu6phGEz9mrGHyshDGtYVjsZUhHM_0d-a23BAJ4"
        },
        success: response => {
